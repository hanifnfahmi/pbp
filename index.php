...
<body>
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            ...
            <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addObat' == $id ) {
                                                                            echo " active";
                                                                        }?>">
                    <a href="index.php?id=addObat"><i id="left" class="fas fa-user-plus"></i></i>Add Obat</a>
            </li>
            <li id="left" class="sideber__item<?php if ( 'allObat' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allObat"><i id="left" class="fas fa-user"></i>All Obat</a>
            </li>
    ...
    echo " active";
        ...
        <!-- <footer class="text-center"><span>PBP</span><br>©2020 Informatika Undip.</footer> -->
    </section>
    <!--------------------------------- #Sideber -------------------------------->
    ...
    <section class="main">
        <div class="container">
            ...
            <?php if ( 'dashboard' == $id ) {?>
                <div class="dashboard p-5">
                    <div class="total">
                        <div class="row">
                            <div class="col-3">
                                <a href="index.php?id=allObat"><div class="total__box text-center">
                                    <h1><?php
                                            $query = "SELECT sum(stok_obat) totalObat FROM obat;";
                                                $result = mysqli_query( $connection, $query );
                                                $totalObat = mysqli_fetch_assoc( $result );
                                                echo $totalObat['totalObat'];
                                            ?></h1>
                                    <h2>Total Obat</h2>
                                </div></a>
                            </div>
                            <div class="col-3">
                                <a href="index.php?id=allManager"><div class="total__box text-center">
                                    <h1>
                                        <?php
                            ...
                            <div class="col-3">
                                <a href="index.php?id=allPharmacist"><div class="total__box text-center">
                                    <h1>
                                        <?php
                            ...
                            <div class="col-3">
                                <a href="index.php?id=allSalesman"><div class="total__box text-center">
                                    <h1><?php
            ...
            <!-- ---------------------- Obat ------------------------ -->
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Tangal Kadaluarsa</th>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $getObat = "SELECT * FROM obat";
                                            $result = mysqli_query( $connection, $getObat );

                                        while ( $obat = mysqli_fetch_assoc( $result ) ) {?>

                                        <tr>
                                            <td>
                                            <?php printf( "%s", $obat['nama_obat'] );?></td>
                                            <td><?php printf( "%s", $obat['harga']);?></td>
                                            <td><?php printf( "%s", $obat['stok_obat'] );?></td>
                                            <td><?php printf( "%s", $obat['tanggal_kadaluarsa'] );?></td>
                                            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole || 'salesman' == $sessionRole) {?>
                                                
                                                <td><?php printf( "<a href='index.php?action=editObat&id=%s'><i class='fas fa-edit'></i></a>", $obat['id_obat'] )?></td>
                                                <td><?php printf( "<a class='delete' href='index.php?action=deleteObat&id=%s'><i class='fas fa-trash'></i></a>", $obat['id_obat'] )?></td>
                                            <?php }?>
                                        </tr>
                ...
                <?php if ( 'addObat' == $id ) {?>
                    <div class="addObat">
                        <div class="main__form">
                            <div class="main__form--title text-center">Add Obat</div>
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    ...
                                    <div class="col col-12">
                                        <label class="input">
                                            <input type="number" name="stok_obat" placeholder="Stok Obat" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <input type="text" name="tanggal_kadaluarsa" placeholder="Tanggal Kadaluarsa" onfocus="(this.type='date')" onblur="(this.type='text')" required>
                                        </label>
                                    </div>
                                    <input type="hidden" name="action" value="addObat">
                                    <div class="col col-12">
                ...
                <?php if ( 'editObat' == $action ) {
                        $obatId = $_REQUEST['id'];
                        $selectObat = "SELECT * FROM obat WHERE id_obat ='{$obatId}'";
                        $result = mysqli_query( $connection, $selectObat );

                    $obat = mysqli_fetch_assoc( $result );?>
                    <div class="addObat">
                        <div class="main__form">
                            <div class="main__form--title text-center">Update Obat</div>
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                                            <input type="text" name="nama_obat" placeholder="Nama obat" value="<?php echo $obat['nama_obat']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <input type="text" name="harga" placeholder="Harga" value="<?php echo $obat['harga']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <input type="number" name="stok_obat" placeholder="Stok Obat" value="<?php echo $obat['stok_obat']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <input type="number" name="tanggal_kadaluarsa" placeholder="Tanggal Kadaluarsa" value="<?php echo $obat['tanggal_kadaluarsa']; ?>" required>
                                        </label>
                                    </div>
                                    <input type="hidden" name="action" value="updateObat">
                                    <input type="hidden" name="id" value="<?php echo $obatId; ?>">
                                    <div class="col col-12">
                ...
                <?php if ( 'deleteObat' == $action ) {
                        $obatId = $_REQUEST['id'];
                        $deleteManager = "DELETE FROM obat WHERE id_obat ='{$obatId}'";
